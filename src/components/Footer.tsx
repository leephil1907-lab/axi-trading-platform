      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          <div className="col-span-2 lg:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-lg text-white tracking-tight">axi</span>
            </div>
            ...
            <div className="flex gap-3">
              {[Facebook, Twitter, Instagram, Linkedin, Youtube].map((Icon, i) => (
                <a key={i} href="#" className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center hover:bg-red-600 transition-colors">
          ...
          <div>
            <h4 className="font-semibold text-white mb-4 text-sm">Markets</h4>
            <ul className="space-y-2 text-sm">
              {["Forex", "Crypto CFDs", "Commodities", "Indices", "Share CFDs", "ETFs"].map((item) => (
                <li key={item}><Link to="/markets" className="hover:text-white transition-colors">{item}</Link></li>
              ))}
            </ul>
          </div>

          <div>
            <h4 className="font-semibold text-white mb-4 text-sm">Platforms</h4>
            <ul className="space-y-2 text-sm">
              {["Axi Trading Platform", "MT4", "MT5", "Copy Trading", "MT4 WebTrader", "MT5 WebTrader"].map((item) => (
                <li key={item}><Link to="/platforms" className="hover:text-white transition-colors">{item}</Link></li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              {["About Axi", "Our Team", "Careers", "Sponsorship", "Investor Relations", "Company News"].map((item) => (
        ...
        <div className="mt-12 pt-8 border-t border-slate-800 text-xs text-slate-500 space-y-4">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p>© 2026 Axi. All rights reserved. Axi is a trading name of AxiCorp Financial Services Pty Ltd.</p>
